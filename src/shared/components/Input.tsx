      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            ...
            "transition-[border-color,box-shadow,background-color] duration-200 ease-[var(--ease-spring-critical)] shadow-inner disabled:opacity-50 disabled:cursor-not-allowed",
            // iOS zoom fix
