...
export default function Tooltip({
  ...
  const baseTooltipClass =
    "z-50 px-2.5 py-1.5 text-xs font-medium text-white bg-gray-900/85 backdrop-blur-md rounded-control shadow-lg pointer-events-none apple-scrim-in motion-reduce:animate-none border border-white/10";
